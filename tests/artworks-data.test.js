...
describe('artwork content foundation', () => {
  ...
  it('centralizes commerce eligibility across approval, media, and trust facts', () => {
    ...
    eligible.medium = { value: 'Acrylique sur toile', reviewStatus: 'owner-approved' };
    eligible.year = { value: 2026, reviewStatus: 'owner-approved' };
    eligible.dimensions = { width: 32, height: 32, depth: null, unit: 'cm', reviewStatus: 'owner-approved' };
    eligible.signaturePlacement = { value: 'Dos', reviewStatus: 'owner-approved' };
    eligible.images.full = { src: '/artworks/VORTEX-5.jpg', alt: 'Vue intégrale vérifiée', reviewStatus: 'owner-approved' };
    eligible.images.details = [{ src: '/artworks/VORTEX-5.jpg', alt: 'Détail vérifié', reviewStatus: 'owner-approved' }];
